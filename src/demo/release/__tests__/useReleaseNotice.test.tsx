	...
	it("detects a newer release and supports dismissal by version", async () => {
		const fetchMock = vi.fn().mockResolvedValue(
			new Response(JSON.stringify({
				tag_name: "v1.0.1",
				name: "Release 1.0.1",
				html_url: "https://github.com/vietdungiitb/vnstockcharts/releases/tag/v1.0.1",
		...
		expect(window.localStorage.getItem("vnstockcharts-release-dismissed-version-v1")).toBe("1.0.1");
