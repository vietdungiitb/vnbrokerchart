...
const translations: Record<DemoLanguage, Record<string, string>> = {
	vi: {
		...
		"brand.openAbout": "Mở hộp thoại giới thiệu VNBrockerChart",
		"about.eyebrow": "Thương hiệu",
		"about.title": "Giới thiệu VNBrockerChart",
		"about.close": "Đóng",
		...
		"library.topbarAria": "Mở hộp thoại giới thiệu VNBrockerChart",
	...
	en: {
		...
		"brand.openAbout": "Open the VNBrockerChart about dialog",
		"about.eyebrow": "Brand",
		"about.title": "About VNBrockerChart",
		"about.close": "Close",
		...
		"library.topbarAria": "Open the VNBrockerChart about dialog",
