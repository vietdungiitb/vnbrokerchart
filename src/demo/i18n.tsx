...
const translations: Record<DemoLanguage, Record<string, string>> = {
	vi: {
		...
		"common.liveVNInvest": "● LIVE · VNInvest",
		...
		"release.checking": "Đang kiểm tra bản phát hành…",
		"release.newVersionAvailable": "Có bản phát hành mới",
		"release.upToDate": "Đang ở phiên bản mới nhất",
		"release.offline": "Ngoại tuyến, chưa kiểm tra được",
		"release.retry": "Thử kiểm tra lại",
		"release.dismiss": "Ẩn thông báo",
		"release.lastChecked": "Đã kiểm tra",
		"footer.about": "Giới thiệu",
		"footer.release": "GitHub Release",
		"footer.version": "Phiên bản v{version}",
		"brand.openAbout": "Mở hộp thoại giới thiệu VNBrokerChart",
		"about.eyebrow": "Thương hiệu",
		"about.title": "Giới thiệu VNBrokerChart",
		"about.close": "Đóng",
		"about.currentVersion": "Phiên bản hiện tại",
		"about.latestVersion": "Phiên bản mới nhất",
		"about.publishedAt": "Ngày phát hành",
		"about.repository": "Kho mã nguồn",
		"about.homepage": "Trang chủ",
		"about.releaseNotes": "Ghi chú phát hành",
		"about.checkAgain": "Kiểm tra lại",
		"about.releasePage": "Trang phát hành",
		"about.openRelease": "Mở trang phát hành mới nhất",
		...
		"settings.maxVisibleBars": "Nến hiển thị tối đa",
		"settings.maxVisibleBarsNote": "Giới hạn số nến trên màn hình, giảm khi chart bị giật/lag.",
		...
		"library.topbarAria": "Mở hộp thoại giới thiệu VNBrokerChart",
		...
		"library.vniHistoryAvailableFrom": "Lịch sử khả dụng từ {date}",
		...
		"profile.menu": "Tài khoản",
		"profile.login": "Đăng nhập",
		"profile.register": "Đăng ký",
		"profile.upgrade": "Nâng cấp tài khoản",
		...
		"drawing.alert": "Cảnh báo",
		"drawing.alertEnabled": "Bật cảnh báo",
		"drawing.alertTrigger": "Kiểu kích hoạt",
		"drawing.alertTouch": "Chạm",
		"drawing.alertBreak": "Phá vỡ",
		"drawing.alertCloseAbove": "Đóng cửa trên",
		"drawing.alertCloseBelow": "Đóng cửa dưới",
		"drawing.selectedCount": "Đã chọn {count} nét vẽ",
		...
		"vninvest.nonTradingDays": "Ngày không giao dịch",
		"vninvest.nonTradingDays.note": "Chuẩn hiển thị cổ phiếu: Ẩn ngày không giao dịch để nén trục thời gian.",
		"vninvest.nonTradingDays.show": "Hiện ngày nghỉ",
		"vninvest.nonTradingDays.hide": "Ẩn ngày nghỉ",
		...
		"vninvest.whale.whale": "Whale Value",
		"vninvest.whale.small": "Small Value",
		"vninvest.whale.summary": "Tổng: {total}B",
		"vninvest.whale.noData": "Chưa có dữ liệu whale",
		"vninvest.connected": "Đã kết nối",
		"vninvest.reConnect": "Đổi Token",
		"vninvest.notice.autoSwitchedToDemo": "Da chuyen sang Demo do token VNInvest khong hop le",
		"settings.datasource": "Nguồn dữ liệu",
		"settings.datasourceKicker": "Kết nối",
		"settings.datasourceTitle": "Cấu hình nguồn dữ liệu",
	},
	en: {
		...
		"release.checking": "Checking release…",
		"release.newVersionAvailable": "New release available",
		"release.upToDate": "You are on the latest version",
		"release.offline": "Offline, release not checked",
		"release.retry": "Try checking again",
		"release.dismiss": "Dismiss notice",
		"release.lastChecked": "Last checked",
		"footer.about": "About",
		"footer.release": "GitHub Release",
		"footer.version": "Version v{version}",
		"brand.openAbout": "Open the VNBrokerChart about dialog",
		"about.eyebrow": "Brand",
		"about.title": "About VNBrokerChart",
		"about.close": "Close",
		"about.currentVersion": "Current version",
		"about.latestVersion": "Latest version",
		"about.publishedAt": "Published at",
		"about.repository": "Repository",
		"about.homepage": "Homepage",
		"about.releaseNotes": "Release notes",
		"about.checkAgain": "Check again",
		"about.releasePage": "Release page",
		"about.openRelease": "Open the latest release page",
		...
		"settings.maxVisibleBars": "Max visible bars",
		"settings.maxVisibleBarsNote": "Limit bars on screen — reduce if the chart lags.",
		...
		"library.topbarAria": "Open the VNBrokerChart about dialog",
		...
		"library.vniHistoryAvailableFrom": "History available from {date}",
		...
		"drawing.alert": "Alert",
		"drawing.alertEnabled": "Enable alert",
		"drawing.alertTrigger": "Trigger",
		"drawing.alertTouch": "Touch",
		"drawing.alertBreak": "Break",
		"drawing.alertCloseAbove": "Close above",
		"drawing.alertCloseBelow": "Close below",
		"drawing.selectedCount": "Selected {count} drawings",
		...
		"vninvest.days": "Days",
		"vninvest.nonTradingDays": "Non-trading days",
		"vninvest.nonTradingDays.note": "Standard stock view: hide non-trading days to compress timeline gaps.",
		"vninvest.nonTradingDays.show": "Show non-trading days",
		"vninvest.nonTradingDays.hide": "Hide non-trading days",
		...
		"vninvest.connected": "Connected",
		"vninvest.reConnect": "Change Token",
		"vninvest.notice.autoSwitchedToDemo": "Switched to Demo because the VNInvest token is invalid",
		"settings.datasource": "Data Source",
		"settings.datasourceKicker": "Connection",
		"settings.datasourceTitle": "Data source configuration",
	},
};
