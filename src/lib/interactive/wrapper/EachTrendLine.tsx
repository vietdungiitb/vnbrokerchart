...
class EachTrendLine extends Component<any, any> {
	[key: string]: any;
...
export function getNewXY(moreProps: any) {
	const { xScale, chartConfig: { yScale }, xAccessor, fullData, mouseXY } = moreProps;
