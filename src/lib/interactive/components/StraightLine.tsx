...
class StraightLine extends Component<any, any> {
	[key: string]: any;
	...
	drawOnCanvas(ctx: CanvasRenderingContext2D, moreProps: any) {
		...
		ctx.setLineDash(getStrokeDasharray(strokeDasharray).split(",").map(d => +d));
...
export function isHovering2(start: any, end: any, [mouseX, mouseY]: [number, number], tolerance: number) {
