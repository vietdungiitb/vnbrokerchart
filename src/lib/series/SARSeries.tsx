...
class SARSeries extends Component<any, any> {
	...
	renderSVG(moreProps: any) {
		...
		return <g className={className}>
			{plotData
				.filter((each: any) => isDefined(yAccessor(each)))
...
SARSeries.defaultProps = {
	...
	opacity: 0.2,
	onClick: function(e: any) { console.log("Click", e); },
	onDoubleClick: function(e: any) { console.log("Double Click", e); },
	onContextMenu: function(e: any) { console.log("Right Click", e); },
};
