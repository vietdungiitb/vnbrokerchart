 ...
 */
export function plotDataLengthBarWidth(props: any, moreProps: any): number {
 ...
 */
export function timeIntervalBarWidth(interval: any) {
	return function(props: any, moreProps: any): number {
		const { widthRatio } = props;
