...
class MouseCoordinateXV2 extends Component<any, any> {
...
function xPosition(props: any, moreProps: any) {
	const { currentItem, xAccessor } = moreProps;
	return xAccessor(currentItem);
}
function getXCoordinateInfo(ctx: any, props: any, moreProps: any) {
