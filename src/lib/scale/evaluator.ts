...
function extentsWrapper(useWholeData: any, clamp: any, pointsPerPxThreshold: any, minPointsPerPxThreshold: any, flipXScale: any) {
	function filterData(
...
function canShowTheseManyPeriods(width: any, arrayLength: any, maxThreshold: any, minThreshold: any) {
...
function showMinThreshold(width: any, threshold: any) {
	return Math.max(1, Math.ceil(width * threshold));
}

function showMaxThreshold(width: any, threshold: any) {
	return Math.floor(width * threshold);
}

function showMax(width: any, threshold: any) {
...
function getFilteredResponse(data: any, left: any, right: any, xAccessor: any) {
	const newLeftIndex = getClosestItemIndexes(data, left, xAccessor, undefined).right;
	const newRightIndex = getClosestItemIndexes(data, right, xAccessor, undefined).left;
