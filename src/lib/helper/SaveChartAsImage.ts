...
const SaveChartAsImage = {
	save(doc: any, container: any, background: any, cb: any) {
		saveAsPng.svgAsDataUri(container.getElementsByTagName("svg")[0], {}, function(uri: any) {
	...
	saveWithWhiteBG(doc: any, container: any, cb: any) {
		return this.saveWithBG(doc, container, "white", cb);
	},
	saveWithDarkBG(doc: any, container: any, cb: any) {
		return this.saveWithBG(doc, container, "#303030", cb);
	},
	saveWithBG(doc: any, container: any, background: any, cb: any) {
		return this.save(doc, container, background, cb);
	},
	saveChartAsImage(container: any) {
		this.saveWithWhiteBG(document, container, function(src: any) {
