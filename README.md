...
> **🔗 Facebook hỗ trợ: [VNInvest - Hệ thống hỗ trợ ra quyết định đầu tư chứng khoán Việt Nam](https://www.facebook.com/profile.php/?id=61574371481450)**
...
Bản này là **Community (open-source, MPL-2.0)**. Phiên bản **Pro+** cung cấp thêm:
...
| **Modular engine packages** — D3 SVG/Canvas| ❌ | ✅ |
