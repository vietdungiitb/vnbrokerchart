import React, { createContext, Component, useMemo, useEffect, useContext, useRef, useReducer, useCallback, Fragment, useState, createElement } from 'react';
...
var PureComponent = class extends React.Component {
...
var StockChartContext = createContext(void 0);
...
var ChartContext = createContext(void 0);
...
var Chart = (props) => {
  ...
  return /* @__PURE__ */ jsx(ChartProvider, { value: { chartId: id, chartConfig }, children: /* @__PURE__ */ jsx("g", { transform: `translate(${x}, ${y})`, children }) });
};
Chart.propTypes = {
  height: PropTypes4.number,
  origin: PropTypes4.oneOfType([PropTypes4.array, PropTypes4.func]),
  id: PropTypes4.oneOfType([PropTypes4.number, PropTypes4.string]).isRequired,
  yExtents: PropTypes4.oneOfType([PropTypes4.array, PropTypes4.func]),
  onContextMenu: PropTypes4.func,
  yScale: PropTypes4.func,
  flipYScale: PropTypes4.bool,
  padding: PropTypes4.oneOfType([
    PropTypes4.number,
    PropTypes4.shape({
      top: PropTypes4.number,
      bottom: PropTypes4.number
    })
  ]),
...
function yDomainFromYExtents(yExtents, yScale, plotData) {
  ...
  const realYDomain = yScale.invert ? extent(allYValues) : Array.from(new Set(allYValues));
  return realYDomain;
}
...
var EventCapture = class extends Component {
  static defaultProps;
  constructor(props) {
    super(props);
    ...
    if (!this.state.panInProgress && this.mouseInteraction) {
      ...
      if (pan) {
        ...
        if (somethingSelected) {
          ...
          select(win2).on(MOUSEMOVE, this.handleDrag).on(MOUSEUP, this.handleDragEnd);
        }
      }
  ...
  handleTouchStart(e) {
    ...
    if (e.touches.length === 1) {
      ...
      if (panInProgress && panEnabled && onPanEnd) {
        ...
        const win = d3Window(this.node);
        select(win).on(MOUSEMOVE, this.mouseInside ? this.handleMouseMove : null).on(MOUSEUP, null).on(TOUCHMOVE, this.handlePinchZoom, false).on(TOUCHEND, this.handlePinchZoomEnd, false);
...
EventCapture.propTypes = {
  mouseMove: PropTypes4.bool.isRequired,
  zoom: PropTypes4.bool.isRequired,
  pan: PropTypes4.bool.isRequired,
  panSpeedMultiplier: PropTypes4.number.isRequired,
  focus: PropTypes4.bool.isRequired,
  useCrossHairStyleCursor: PropTypes4.bool.isRequired,
  width: PropTypes4.number.isRequired,
  height: PropTypes4.number.isRequired,
  chartConfig: PropTypes4.array,
  xScale: PropTypes4.func.isRequired,
  xAccessor: PropTypes4.func.isRequired,
  disableInteraction: PropTypes4.bool.isRequired,
  getAllPanConditions: PropTypes4.func.isRequired,
  onMouseMove: PropTypes4.func,
  onMouseEnter: PropTypes4.func,
  onMouseLeave: PropTypes4.func,
  onZoom: PropTypes4.func,
  onPinchZoom: PropTypes4.func,
  onPinchZoomEnd: PropTypes4.func.isRequired,
  onPan: PropTypes4.func,
  onPanEnd: PropTypes4.func,
  onDragStart: PropTypes4.func,
  onDrag: PropTypes4.func,
  onDragComplete: PropTypes4.func,
  onClick: PropTypes4.func,
  onDoubleClick: PropTypes4.func,
  onContextMenu: PropTypes4.func,
  onMouseDown: PropTypes4.func,
  children: PropTypes4.node
};
...
var CanvasContainer = class extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxs("div", { style: { position: "absolute", zIndex }, children: [
      /* @__PURE__ */ jsx(
        "canvas",
        {
          id: "bg",
...
CanvasContainer.propTypes = {
  ...
  zIndex: PropTypes4.number,
  ratio: PropTypes4.number.isRequired
};
...
function getCursorStyle() {
  ...
  return /* @__PURE__ */ jsx("style", { type: "text/css", children: tooltipStyle });
}
...
function calculateState(props) {
  ...
  const dimensions = getDimensions2(props);
  const extent2 = typeof xExtentsProp === "function" ? xExtentsProp(data) : extent(xExtentsProp.map((d) => functor(d)).map((each) => each(data, inputXAccesor)));
...
var ChartCanvas = class extends Component {
  static defaultProps;
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx(StockChartProvider, { value: contextValue, children: /* @__PURE__ */ jsxs("div", { style: { position: "relative", width, height }, className, onClick: onSelect, children: [
      /* @__PURE__ */ jsx(CanvasContainer_default, { ref: this.saveCanvasContainerNode, type, ratio, width, height, zIndex }),
      /* @__PURE__ */ jsxs("svg", { className, width, height, style: { position: "absolute", zIndex: zIndex + 5 }, children: [
        cursor,
        /* @__PURE__ */ jsxs("defs", { children: [
          /* @__PURE__ */ jsx("clipPath", { id: "chart-area-clip", children: /* @__PURE__ */ jsx("rect", { x: "0", y: "0", width: dimensions.width, height: dimensions.height }) }),
          chartConfig.map((each, idx) => /* @__PURE__ */ jsx("clipPath", { id: `chart-area-clip-${each.id}`, children: /* @__PURE__ */ jsx("rect", { x: "0", y: "0", width: each.width, height: each.height }) }, idx))
        ] }),
        /* @__PURE__ */ jsxs("g", { transform: `translate(${margin.left + 0.5}, ${margin.top + 0.5})`, children: [
          /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsx("g", { className: "react-stockcharts-avoid-interaction", children })
        ] })
      ] })
    ] }) });
  }
...
ChartCanvas.propTypes = {
  width: PropTypes4.number.isRequired,
  height: PropTypes4.number.isRequired,
  margin: PropTypes4.object,
  ratio: PropTypes4.number.isRequired,
  type: PropTypes4.oneOf(["svg", "hybrid"]),
  data: PropTypes4.array.isRequired,
  xAccessor: PropTypes4.func,
  xExtents: PropTypes4.oneOfType([PropTypes4.array, PropTypes4.func]),
  zoomAnchor: PropTypes4.func,
  className: PropTypes4.string,
  seriesName: PropTypes4.string.isRequired,
  zIndex: PropTypes4.number,
  children: PropTypes4.node.isRequired,
  xScale: PropTypes4.func.isRequired,
  postCalculator: PropTypes4.func,
  flipXScale: PropTypes4.bool,
  useCrossHairStyleCursor: PropTypes4.bool,
  padding: PropTypes4.oneOfType([PropTypes4.number, PropTypes4.shape({ left: PropTypes4.number, right: PropTypes4.number })]),
  defaultFocus: PropTypes4.bool,
  zoomMultiplier: PropTypes4.number,
  onLoadMore: PropTypes4.func,
  displayXAccessor: PropTypes4.func,
  mouseMoveEvent: PropTypes4.bool,
  panEvent: PropTypes4.bool,
  clamp: PropTypes4.oneOfType([PropTypes4.string, PropTypes4.bool, PropTypes4.func]),
  zoomEvent: PropTypes4.bool,
  onSelect: PropTypes4.func,
  onVisibleDomainChange: PropTypes4.func,
  maintainPointsPerPixelOnResize: PropTypes4.bool,
  disableInteraction: PropTypes4.bool
};
...
var GenericComponent = class extends Component {
  ...
  static propTypes = {
    svgDraw: PropTypes4.func.isRequired,
    canvasDraw: PropTypes4.func,
    drawOn: PropTypes4.array.isRequired,
    clip: PropTypes4.bool.isRequired,
    edgeClip: PropTypes4.bool.isRequired,
    interactiveCursorClass: PropTypes4.string,
    selected: PropTypes4.bool.isRequired,
    enableDragOnHover: PropTypes4.bool.isRequired,
    disablePan: PropTypes4.bool.isRequired,
    canvasToDraw: PropTypes4.func.isRequired,
    isHover: PropTypes4.func,
    onClick: PropTypes4.func,
    onClickWhenHover: PropTypes4.func,
    onClickOutside: PropTypes4.func,
    onPan: PropTypes4.func,
    onPanEnd: PropTypes4.func,
    onDragStart: PropTypes4.func,
    onDrag: PropTypes4.func,
    onDragComplete: PropTypes4.func,
    onDoubleClick: PropTypes4.func,
    onDoubleClickWhenHover: PropTypes4.func,
    onContextMenu: PropTypes4.func,
    onContextMenuWhenHover: PropTypes4.func,
    onMouseMove: PropTypes4.func,
    onMouseDown: PropTypes4.func,
    onHover: PropTypes4.func,
    onUnHover: PropTypes4.func,
    chartId: PropTypes4.oneOfType([PropTypes4.number, PropTypes4.string])
  };
  static defaultProps = {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx("g", { style, children: svgDraw(this.getMoreProps()) });
  }
};
...
var GenericChartComponentWrapper = (props) => {
  ...
  return /* @__PURE__ */ jsx(GenericChartComponent, { ...props, chartId });
};
...
var BackgroundText = class _BackgroundText extends PureComponent_default {
  ...
  render() {
    ...
    const interval = isDefined(this.props.interval) ? this.props.interval : this.context.interval;
    return /* @__PURE__ */ jsx("text", { ...props, children: this.props.children(interval) });
  }
};
...
BackgroundText.propTypes = {
  x: PropTypes4.number.isRequired,
  y: PropTypes4.number.isRequired,
  fontFamily: PropTypes4.string,
  fontSize: PropTypes4.number.isRequired,
  fill: PropTypes4.string,
  stroke: PropTypes4.string,
  opacity: PropTypes4.number,
  strokeOpacity: PropTypes4.number,
  textAnchor: PropTypes4.string,
  children: PropTypes4.func,
  interval: PropTypes4.string
};
...
function withChartAndStockChart(Component6) {
  return function WrappedComponent(props) {
    ...
    return /* @__PURE__ */ jsx(Component6, { ...props, stockChartContext, chartContext });
  };
}
var ZoomButtons = class extends Component {
  static defaultProps;
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxs("g", { className: "react-stockcharts-zoom-button", children: [
      /* @__PURE__ */ jsx(
        "rect",
        {
          x: zoomOutX - w / 2,
      ...
      /* @__PURE__ */ jsx("g", { transform: `translate (${resetX}, ${y + h / 4}) scale(.14)`, children: /* @__PURE__ */ jsx(
        "path",
        {
...
ZoomButtons.propTypes = {
  zoomMultiplier: PropTypes4.number.isRequired,
  size: PropTypes4.array.isRequired,
  heightFromBase: PropTypes4.number.isRequired,
  rx: PropTypes4.number.isRequired,
  ry: PropTypes4.number.isRequired,
  stroke: PropTypes4.string.isRequired,
  strokeWidth: PropTypes4.number.isRequired,
  strokeOpacity: PropTypes4.number.isRequired,
  fill: PropTypes4.string.isRequired,
  fillOpacity: PropTypes4.number.isRequired,
  fontSize: PropTypes4.number.isRequired,
  textDy: PropTypes4.string.isRequired,
  textFill: PropTypes4.string.isRequired,
  textStrokeWidth: PropTypes4.number.isRequired,
  onReset: PropTypes4.func
};
...
function computeScales(pane, data, canvasHeight) {
  ...
  const leftScale = scaleLinear().domain(leftValues).range([canvasHeight, 0]).nice();
  ...
  const rightScale = scaleLinear().domain(rightValues).range([canvasHeight, canvasHeight * 0.75]).nice();
...
function ChartPane({ pane, children, className, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx("section", { ...rest, ref: containerRef, className, style: mergedStyle, "data-pane-id": pane.id, children: /* @__PURE__ */ jsxs("div", { style: { position: "relative", flex: "1 1 auto", minHeight: 0 }, children: [
    /* @__PURE__ */ jsx(
      "canvas",
      {
        ref: mainCanvasRef,
    ...
    /* @__PURE__ */ jsx(ChartSyncProvider, { value: syncValue, children })
  ] }) });
}
...
var PaneManagerContext = createContext(void 0);
...
function usePaneManager(initialPanes = []) {
  ...
  const resizePane = useCallback((paneId, heightPx) => {
    dispatch({ type: "resizePane", paneId, heightPx });
  }, []);
  const addIndicator = useCallback((paneId, indicator) => {
    dispatch({ type: "addIndicator", paneId, indicator });
  }, []);
  const removeIndicator = useCallback((paneId, indicatorName) => {
    dispatch({ type: "removeIndicator", paneId, indicatorName });
  }, []);
  const updateIndicator = useCallback((paneId, indicatorName, patch) => {
...
function ChartTerminal({ data, panes, adapter, children, className, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx(PaneManagerProvider, { value: paneState, children: /* @__PURE__ */ jsx(DataProvider, { value: { data, adapter }, children: /* @__PURE__ */ jsxs("section", { ...rest, className, style: mergedStyle, children: [
    paneState.panes.map((pane, index) => /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(ChartPane, { pane }),
      index < paneState.panes.length - 1 ? /* @__PURE__ */ jsx(PaneSplitter, { onResize: (heightPx) => paneState.resizePane(pane.id, heightPx) }) : null
    ] }, pane.id)),
    children
  ] }) }) });
}
...
export { BackgroundText_default as BackgroundText, BaseAdapter, Chart_default as Chart, ChartCanvas_default as ChartCanvas, ChartPane, ChartTerminal, DjangoVnstockAdapter, GenericChartComponent_default as GenericChartComponent, GenericComponent_default as GenericComponent, MockAdapter, PaneSplitter, ZoomButtons_default as ZoomButtons, createDraftFromTool, createDrawingHistory, createTool as createDrawingTool, createMockBars, createRestAdapter, deserializeDrawingHistory, deserializeDrawingObject, deserializeDrawings, drawingReducer, getIndicator, historyReducer, isDrawingToolName, listDrawingTools, registerDrawingTool, registerIndicator, serializeDrawingHistory, serializeDrawingObject, serializeDrawings, usePaneManager, version };
